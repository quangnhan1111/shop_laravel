...
class OrderController extends Controller
{
	...
	public function view_order($order_code){
        ...
        // vì tat ca các sp trong 1 lần order đều có chung 1 coupon nên chỉ cần làm như này
		foreach($order_details_product as $key => $order_d){
    ...
    public function manage_order(){
        ...
        $manager_order_product  = view('admin.manage_order')->with('order',$order);
    	return view('admin_layout')->with('admin.manage_order', $manager_order_product);
    }
}
